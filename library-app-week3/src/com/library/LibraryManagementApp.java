...
public class LibraryManagementApp {
    ...
    private void handleAddBook() {
        ...
        try {
            ...
            // Defence-in-depth: CLI-level prompts already validate input, but
            // BookInventory now validates independently too (Week 3), in case
            // it is ever called from somewhere other than this menu.
            System.out.println("Error: " + e.getMessage());
        }
    }
     ...
     *  Delegates the actual boundary check to Book.isValidPublicationYear so this
     *  class and BookInventory never have two different definitions of "valid year". */
